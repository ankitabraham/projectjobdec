...
import com.orangee.uitest.pageobject.loginpage1;
...
public class TC01_invalid_login2 extends TestBase
{
     ...
     loginpage1 login;
		// TODO Auto-generated method stub
			...
			@Test
	    	 void TC02_InvalidLogin_Test() throws Exception {
	    	...
	    	if((actualMessage).equals(expectedMessage)) { // asserting actual = expected
	    		...
	    		System.out.println("testcase failed/probs");
